...
public class UserServiceImpl implements UserService {
	...
	public void sendSmsCode(String phone) throws IOException {
		...
		redisTemplate.boundValueOps(phone).set(randomNumeric,15L, TimeUnit.MINUTES);
		...
		httpClient.addParameter("param","{\"code\":"+randomNumeric+"}");
		httpClient.post();
	}

	@Override
	public Map<String, Object> checkCode(String phone, String smsCode) {
